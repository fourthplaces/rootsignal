...
impl From<taproot_domains::entities::Entity> for GqlEntity {
    fn from(e: taproot_domains::entities::Entity) -> Self {
        Self {
            id: e.id,
            name: e.name,
...
impl GqlEntity {
    ...
    async fn services(&self, ctx: &Context<'_>) -> Result<Vec<GqlService>> {
        ...
        let services = taproot_domains::entities::Service::find_by_entity_id(self.id, pool)
            .await
            .unwrap_or_default();
...
impl From<taproot_domains::entities::Service> for GqlService {
    fn from(s: taproot_domains::entities::Service) -> Self {
        Self {
            id: s.id,
