# Hardcoded City Profiles (Archived 2026-02-17)

Preserved from `rootsignal-scout/src/sources.rs` before dynamic city support.
These profiles were the original compile-time source configurations.
...
handsontwincities, unitedwaytc, tchabitat, secondharvestheartland, everymealorg,
loavesandfishesmn, openarmsmn, communityaidnetworkmn, peopleservingpeople,
pillsburyunited, minneapolisparks, friendsmissriv, parkconnection, miracmn,
unidosmn, immigrantlawcentermn, cluesofficial, voices4rj, hclib,
stpaulpubliclibrary, youthlinkmn, achievetwincities, ywcampls, agateservicesmn,
communityaidnetworkmn, nhn_tc, sadeinthecities, sj_tapp, minnesota_neighbors
...
MutualAidMPLS, MutualAidMN, VolunteerMN, MinneapolisVolunteer,
TwinCitiesMutualAid, MplsMutualAid, SaintPaulMutualAid

### Entity Mappings

| entity_id | domains | instagram | facebook |
|---|---|---|---|
| handsontwincities.org | handsontwincities.org | handsontwincities | facebook.com/HandsOnTC |
| gtcuw.org | gtcuw.org | unitedwaytc | facebook.com/unitedwaytwincities |
| 2harvest.org | 2harvest.org | secondharvestheartland | facebook.com/2harvest |
| everymeal.org | everymeal.org, everymealorg | everymealorg | facebook.com/EveryMealOrg |
| openarmsmn.org | openarmsmn.org | openarmsmn | facebook.com/openarmsmn |
| tchabitat.org | tchabitat.org | tchabitat | facebook.com/tchabitat |
| fmr.org | fmr.org | friendsmissriv | facebook.com/FriendsMissRiv |
| mirac-mn.org | mirac-mn.org, miracmn | miracmn | facebook.com/miracmn |
| unidosmn.org | unidosmn.org | unidosmn | facebook.com/unidosmn |
| ilcm.org | ilcm.org, immigrantlawcenter | immigrantlawcentermn | facebook.com/immigrantlawcenterMN |
| clues.org | clues.org | cluesofficial | facebook.com/CLUESPage |
| loavesandfishesmn.org | loavesandfishesmn.org | loavesandfishesmn | - |
| minneapolisparks.org | minneapolisparks.org | minneapolisparks | - |
| pillsburyunited.org | pillsburyunited.org | pillsburyunited | - |
| hclib.org | hclib.org | hclib | - |
| sppl.org | sppl.org | stpaulpubliclibrary | - |
...
- **Radius:** 25 km
- **Geo terms:** New York, NYC, Brooklyn, Manhattan, Queens, Bronx, Staten Island, Harlem, NY
...
- **Lat/Lng:** 45.5152, -122.6784
- **Radius:** 20 km
- **Geo terms:** Portland, Oregon, Multnomah, Clackamas, Washington County, OR
- **Instagram/Facebook/Entity mappings:** none (empty)
- **Discovery topics:** none
...
- **Radius:** 20 km
- **Geo terms:** Berlin, Kreuzberg, Neukolln, Friedrichshain, Charlottenburg, Mitte, Prenzlauer Berg
- **Instagram/Facebook/Entity mappings:** none (empty)
- **Discovery topics:** none
...
- Berlin Burgeramt public meeting
...
- Berlin civic participation Burgerbeteiligung
- Berlin repair cafe
