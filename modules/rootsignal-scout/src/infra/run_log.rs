...
impl RunLogger {
    ...
    fn track_impl(&self, kind: EventKind, parent_id: Option<Uuid>) -> EventHandle {
        ...
        if let Ok(mut events) = self.events.lock() {
            events.push(InMemoryEvent { _seq: seq, event_type: event_type.to_string() });
        }
...
pub trait EventLogger: Send + Sync {
    ...
    fn log(&self, kind: EventKind) { self.track(kind); }
}
...
async fn insert_event(
    ...
    let (
        source_url, query, url, provider, platform, identifier,
...
fn extract_columns(kind: &EventKind) -> (
    ...
    match kind {
        EventKind::ReapExpired { gatherings, needs, stale } => (
            None, None, None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            Some(*gatherings), Some(*needs), Some(*stale), None,
            None, None, None, None, None, None,
            None, None, None, None, None,
        ),
        EventKind::Bootstrap { sources_created } => (
            ...
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, Some(*sources_created),
            None, None, None, None, None, None,
            None, None, None, None, None,
        ),
        EventKind::SearchQuery { query, provider, result_count, canonical_key } => (
            None, Some(query.clone()), None, Some(provider.clone()), None, None,
            None, None, Some(*result_count), None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, Some(canonical_key.clone()),
            None, None, None, None,
            None, None, None, None, None, None,
            None, None, None, None, None,
        ),
        EventKind::ScrapeUrl { url, strategy, success, content_bytes } => (
            None, None, Some(url.clone()), None, None, None,
            None, None, None, None, None,
            Some(*content_bytes), None, None, None,
            None, None, Some(*success), None, None,
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, None, Some(strategy.clone()),
            None, None, None, None, None,
        ),
        EventKind::ScrapeFeed { url, items } => (
            None, None, Some(url.clone()), None, None, None,
            None, None, None, None, Some(*items),
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
        ...
        EventKind::SocialScrape { platform, identifier, post_count } => (
            None, None, None, None, Some(platform.clone()), Some(identifier.clone()),
            None, None, None, Some(*post_count), None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
        ...
        EventKind::SocialTopicSearch { platform, topics, posts_found } => (
            None, None, None, None, Some(platform.clone()), None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
            None, None, Some(topics.clone()), Some(*posts_found), None, None,
            None, None, None, None, None,
        ),
        EventKind::LlmExtraction { source_url, content_chars, signals_extracted, implied_queries } => (
            Some(source_url.clone()), None, None, None, None, None,
            None, None, None, None, None,
            None, Some(*content_chars), Some(*signals_extracted), Some(*implied_queries),
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, None, None,
        ...
        EventKind::SignalCreated { node_id, signal_type, title, confidence, source_url } => (
            Some(source_url.clone()), None, None, None, None, None,
            Some(signal_type.clone()), Some(title.clone()), None, None, None,
            None, None, None, None,
            None, Some(*confidence), None, None, Some(node_id.clone()),
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, None, None,
            None, None, None, None, None,
        ),
        EventKind::SignalDeduplicated { signal_type, title, matched_id, similarity, action, source_url, summary } => (
            Some(source_url.clone()), None, None, None, None, None,
            Some(signal_type.clone()), Some(title.clone()), None, None, None,
            None, None, None, None,
            Some(*similarity), None, None, Some(action.clone()), None,
            Some(matched_id.clone()), None, None, None,
            None, None, None, None,
            None, None, None, None, None, None,
            None, None, None, None, Some(summary.clone()),
        ),
        EventKind::SignalCorroborated { existing_id, signal_type, title, new_source_url, similarity, summary } => (
            None, None, None, None, None, None,
            Some(signal_type.clone()), Some(title.clone()), None, None, None,
            None, None, None, None,
            Some(*similarity), None, None, None, None,
            None, Some(existing_id.clone()), Some(new_source_url.clone()), None,
            None, None, None, None,
            None, None, None, None, None, None,
            None, None, None, None, Some(summary.clone()),
        ),
        EventKind::SignalRejected { title, source_url, reason } => (
            Some(source_url.clone()), None, None, None, None, None,
            ...
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, Some(reason.clone()), None,
            None, None, None, None, None,
        ),
        EventKind::ExpansionQueryCollected { query, source_url } => (
            Some(source_url.clone()), Some(query.clone()), None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
        ...
        EventKind::ExpansionSourceCreated { canonical_key, query, source_url } => (
            Some(source_url.clone()), Some(query.clone()), None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None, None,
        ...
        EventKind::BudgetCheckpoint { spent_cents, remaining_cents } => (
            None, None, None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
            Some(*spent_cents), Some(*remaining_cents), None, None, None, None,
            None, None, None, None, None,
        ),
        EventKind::LintBatch { source_url, signal_count, passed, corrected, rejected } => (
            Some(source_url.clone()), None, None, None, None, None,
            None, None, Some(*passed), Some(*corrected), Some(*rejected),
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, None, None,
            None, None, None, Some(*signal_count), None,
        ),
        EventKind::LintCorrection { node_id, signal_type, title, field, old_value, new_value, reason } => (
            None, None, None, None, None, None,
            Some(signal_type.clone()), Some(title.clone()), None, None, None,
            None, None, None, None,
            None, None, None, None, Some(node_id.clone()),
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, Some(reason.clone()), None,
            Some(field.clone()), Some(old_value.clone()), Some(new_value.clone()), None, None,
        ),
        EventKind::LintRejection { node_id, signal_type, title, reason } => (
            None, None, None, None, None, None,
            Some(signal_type.clone()), Some(title.clone()), None, None, None,
            None, None, None, None,
            None, None, None, None, Some(node_id.clone()),
        ...
        EventKind::AgentWebSearch { provider, query, result_count, title } => (
            None, Some(query.clone()), None, Some(provider.clone()), None, None,
            None, Some(title.clone()), Some(*result_count), None, None,
            None, None, None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
        ...
        EventKind::AgentPageRead { provider, url, content_chars, title } => (
            None, None, Some(url.clone()), Some(provider.clone()), None, None,
            None, Some(title.clone()), None, None, None,
            None, Some(*content_chars), None, None,
            None, None, None, None, None,
            None, None, None, None,
            None, None, None, None,
            None, None, None, None, None, None,
        ...
        EventKind::AgentFutureQuery { provider, query, title } => (
            None, Some(query.clone()), None, Some(provider.clone()), None, None,
            None, Some(title.clone()), None, None, None,
            None, None, None, None,
            None, None, None, None, None,
