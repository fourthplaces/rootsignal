    ...
    fn tension_at(title: &str, lat: f64, lng: f64) -> Node {
        Node::Concern(ConcernNode {
            meta: NodeMeta {
                ...
                confidence: 0.0,
                corroboration_count: 0,
                locations: vec![Location { point: Some(GeoPoint { lat, lng, precision: GeoPrecision::Approximate }), name: None, address: None, role: None, timezone: None }],
                url: String::new(),
                extracted_at: Utc::now(),
                published_at: None,
                last_confirmed_active: Utc::now(),
    ...
    fn tension_with_name(title: &str, location_name: &str) -> Node {
        Node::Concern(ConcernNode {
            meta: NodeMeta {
                ...
                confidence: 0.0,
                corroboration_count: 0,
                locations: vec![Location { point: None, name: Some(location_name.to_string()), address: None, role: None, timezone: None }],
                url: String::new(),
                extracted_at: Utc::now(),
                published_at: None,
                last_confirmed_active: Utc::now(),
