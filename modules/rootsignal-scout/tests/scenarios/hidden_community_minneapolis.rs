//! Scenario 5: Invisible Community Spaces — community life in non-obvious places.

use simweb::{Fact, Geography, JudgeCriteria, Site, SocialProfile, World};

pub fn world() -> World {
    World {
        name: "Hidden Community Minneapolis".to_string(),
        description: "Minneapolis neighborhood where community life happens in non-obvious places. \
        ...
        facts: vec![
            Fact {
                ...
                category: "informal_community".to_string(),
            },
            Fact {
            ...
            Fact {
                text: "These three locations form an informal community infrastructure network in Powderhorn/Phillips neighborhoods".to_string(),
                referenced_by: vec![
                    "https://powderhorn-voice.org/hidden-community-spaces".to_string(),
                ],
                category: "community_infrastructure".to_string(),
            },
        ],
        sites: vec![
            Site {
                ...
                content_description: "Blog post titled 'The Hidden Community Spaces of South Minneapolis'. \
        ...
        social_profiles: vec![
            SocialProfile {
                ...
                persona: "Lake Street community account. Posts about local businesses, \
                    events, and community activities including the barbershop voter registration. \
...
pub fn criteria() -> JudgeCriteria {
    JudgeCriteria {
        checks: vec![
            "The agent should detect community activity from informal sources (barbershop, church basement, laundromat) even though none are .org or .gov sites.".to_string(),
            ...
            "The agent should NOT require formal institutional sources to recognize community infrastructure.".to_string(),
        ...
        critical_categories: vec![
            "informal_community_detection".to_string(),
        ],
    }
}
