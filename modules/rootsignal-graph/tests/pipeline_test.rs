...
use rootsignal_common::{
    ActorType, ChannelType, GeoPoint, GeoPrecision, SensitivityLevel,
};
...
async fn pipeline_creates_evidence_and_computes_diversity() {
    ...
    let events = vec![
        ...
        stored(3, &Event::CitationRecorded {
            citation_id: ev2_id,
            entity_id: signal_id,
...
async fn pipeline_actor_signal_count_computed_after_reduce() {
    ...
    let events = vec![
        stored(1, &Event::TensionDiscovered {
            id: sig1,
        ...
        stored(3, &Event::ActorIdentified {
            actor_id,
        ...
        stored(4, &Event::ActorLinkedToEntity {
            actor_id,
            entity_id: sig2,
            role: "provider".into(),
        }),
